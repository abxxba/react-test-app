...
import CreateIcon from "@material-ui/icons/MoveToInbox";
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <List>
          <Link to="/employee/create">
            <ListItem button key={"Register Employee"}>
              <ListItemIcon>
      ...
      >
        <div className={classes.drawerHeader} />
        <Switch>
          <Route path="/" component={employeesTable} exact />
          <Route path="/employee/list" component={employeesTable} />
